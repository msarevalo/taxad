...
<div class="container">
        <form action="{{route('separador.editar', $separador->id)}}" method="post">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="nombre" type="text" class="form-control @error('nombre') is-invalid @enderror" name="nombre" required autocomplete="nombre" autofocus value="{{$separador->nombre}}">
                    ...
                    <select class="form-control mb-2" name="menu" id="menu" required style="text-transform: capitalize">
                        ...
                        @foreach($padres as $padre)
                            @if($padre->nombre!="Cerrar Sesión")
                                @if($separador->menu_posterior==$padre->id)
