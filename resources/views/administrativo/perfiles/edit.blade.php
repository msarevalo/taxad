...
<div class="container">
        <form action="{{ route('perfil.editar', $perfil->id) }}" method="post">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="nombre" type="text" class="form-control @error('nombre') is-invalid @enderror" name="nombre" required autocomplete="nombre" autofocus value="{{$perfil->nombrePerfil}}">
